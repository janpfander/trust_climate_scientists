...
Our main outcome of interest is people's perception of climate scientists' trustworthiness, along various dimensions (see @tbl-trustworthiness). In addition to this, we will also measure several other variables which remain to be determined. All intervention proposals should only target the main outcome variable.

```{r}
#| label: tbl-trustworthiness
#| tbl-cap: "Our measure of perceived trustworthiness of climate scientists will be an index of the items presented here."
...
trustworthiness_items <- tribble(
  ...
  # Competence
  "", "We are interested in your general opinion about climate scientists, including scientists working at universities, in government, at companies, and for non-profit organizations. In answering the following questions, think about climate scientists specifically in the context of their work/research.", "",
...
We will recruit representative samples for several demographic variables.
