...
trustworthiness_items |>
  ...
  pack_rows("Trustworthiness of climate scientists", 1, 12) |>
  pack_rows("Normative perceptions of climate scientists", 13, 18) |>
  pack_rows("Willingness to be vulnerable to the advice of climate scientists", 19, 21)
```
...
## Normative perceptions (scientists in policy)
