...
Our main outcome of interest is people's trust in climate scientists, along various dimensions (see @tbl-trust). In addition to this, we will also measure several other variables which remain to be determined. All intervention proposals should only target the main outcome variable.

```{r}
#| label: tbl-trust
#| tbl-cap: "Our measure of trust in climate scientists."
