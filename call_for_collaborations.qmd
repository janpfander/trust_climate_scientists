...
We will compare the efficacy of interventions based on how they change trust in climate scientists across the full sample, not within specific sub-groups.

# Can I submit different interventions for different participants?

It is acceptable for an intervention to vary based on participant features. Variables that will be available are age, gender, race, education, and partisan identity. 

However, all participants need to receive the same kind of intervention. For example, an “ingroup source” intervention can use a pro-Democrat source for informing Democrat participants, and a pro-Republican source for informing Republican participants. In this case, the intervention would have the exact same instructions for all participants, but the "ingroup" varies as a function of each participants' partisan affiliation. 

If you have questions whether your intervention satisfies these criteria, you are welcome to [email us]((mailto:{{< var email >}})) about the suitability of your intervention before you submit it.
