...
It is acceptable for an intervention to vary based on participant features (e.g., their partisanship, gender, race). For example, an “ingroup source” intervention can use a pro-Democrat source for informing Democrat participants, and a pro-Republican source for informing Republican participants. In this case, the intervention would have the exact same instructions for all participants, but the "ingroup" varies as a function of each participants' partisan affiliation. If you have questions whether your intervention satisfies these criteria, you are welcome to [email us](mailto:stics.megastudy@gmail.com) about the suitability of your intervention before you submit it.
