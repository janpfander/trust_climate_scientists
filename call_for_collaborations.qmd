...
We have accepted submissions *until Tuesday, November 11, 2025 at 23:59 Central European Time (CET)*.
...
Yes, we are open to interactive intervention proposals (e.g., chatbots, LLM-based interventions).

If you plan to submit an interactive intervention, please describe the **feasibility** of integrating it into a Qualtrics online survey.

If your intervention involves an LLM, please **theoretically motivate your prompt**, as the prompt will be a key feature distinguishing your submission from other LLM-based interventions.

# What will the control group look like?

To ensure a fair comparison across all interventions, each will be evaluated against the **same control group**.

The specific design of the control group will be determined **after** we have received and reviewed all intervention proposals. Having a complete overview of the submitted interventions will help us design a more appropriate and informative control condition.

In your proposal, you are welcome to describe what you consider an ideal control group. Your input will help us identify important design considerations when developing the final control condition. 
...
Please feel free to email us at [{{< var email >}}](mailto:{{< var email >}}).
